                       ...
                       struct dwconf_s *config_data)
{
    ...
    for (; len > 0;) {
        ...
        case DW_CFA_restore:
            reg = ibyte & 0x3f;
            cout << "\t" << IToDec(off,2) << " DW_CFA_restore ";
            printreg((Dwarf_Signed) reg, config_data);
            cout << endl;
            break;
        ...
        default:
            ...
            case DW_CFA_advance_loc1:
                ...
                off += 1;
                cout << "\t" << IToDec(loff,2);
                cout << " DW_CFA_advance_loc1 " << uval2 << endl;
                break;
            case DW_CFA_advance_loc2:
                ...
                off += 2;
                cout << "\t" << IToDec(loff,2);
                cout << " DW_CFA_advance_loc2 " << uval2 << endl;
                break;
            case DW_CFA_advance_loc4:
                ...
                off += 4;
                cout << "\t" << IToDec(loff,2);
                cout << " DW_CFA_advance_loc4 " << uval2 << endl;
                break;
            case DW_CFA_MIPS_advance_loc8:
                ...
                off += 8;
                cout << "\t" << IToDec(loff,2);
                cout << " DW_CFA_MIPS_advance_loc8 " << uval2 << endl;
                break;
            ...
            case DW_CFA_remember_state:
                cout << "\t" << IToDec(loff,2);
                cout << " DW_CFA_remember_state";
                cout << endl;
                break;
            case DW_CFA_restore_state:
                cout << "\t" << IToDec(loff,2);
                cout << " DW_CFA_restore_state";
                cout << endl;
                break;
            case DW_CFA_def_cfa:
                uval = local_dwarf_decode_u_leb128(instp + 1, &uleblen);
            ...
            case DW_CFA_def_cfa_offset:
                ...
                off += uleblen;
                cout << "\t" << IToDec(loff,2);
                cout << " DW_CFA_def_cfa_offset " << uval;
                cout << endl;
                break;
            ...
            case DW_CFA_def_cfa_expression:     /* DWARF3 */
                {
                    ...
                    cout << "\t" << IToDec(loff,2);
                    cout <<
                        " DW_CFA_def_cfa_expression expr block len " <<
                           block_len << endl;
            ...
            case DW_CFA_cfa_offset_extended_sf: /* DWARF3 */
                ...
                off += uleblen;
                {
                    ...
                    off += uleblen;
                    cout << "\t" << IToDec(loff,2);
                    cout << " DW_CFA_offset_extended_sf ";
                    printreg((Dwarf_Signed) uval, config_data);
                    cout << " " << ((Dwarf_Signed)
            ...
            case DW_CFA_def_cfa_offset_sf:      /* DWARF3 */
                {
                    ...
                    off += uleblen;
                    cout << "\t" << IToDec(loff,2);
                    cout << " DW_CFA_def_cfa_offset_sf " << sval;
                    cout << " (*data alignment factor=> "<< 
            ...
            case DW_CFA_val_expression: /* DWARF3 */
                ...
                off += uleblen;
                {
                    ...
                    off += uleblen;
                    cout << "\t" << IToDec(loff,2);
                    cout << " DW_CFA_val_expression " << uval;
                    cout << " expr block len " << block_len << endl;
                    dump_block("\t\t", (char *) instp+1,
                               (Dwarf_Signed) block_len);
                    cout << endl;
            ...
            case DW_CFA_GNU_window_save:{
                    ...
                    cout << "\t" << IToDec(loff,2);
                    cout << " DW_CFA_GNU_window_save " << endl;
                    break;
                }
#endif
            ...
            case DW_CFA_GNU_negative_offset_extended:{
                    cout << "\t" << IToDec(loff,2);
                    cout << " DW_CFA_GNU_negative_offset_extended "<<
                        endl;
                }
#endif
            ...
            case DW_CFA_GNU_args_size:{
                    ...
                    lreg =
                        local_dwarf_decode_u_leb128(instp + 1,
                                                    &uleblen);
                    cout << "\t" << IToDec(loff,2);
                    cout << " DW_CFA_GNU_args_size arg size: "  <<
                        lreg << endl;
                    instp += uleblen;
                    len -= uleblen;
                    off += uleblen;
