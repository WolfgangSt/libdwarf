...
printf("dadebug extension size %d offset size %d\n",extension_size,uword_size);
printf("dadebug elf int sect %d ext sect %d, net len %d 0x%x\n",(int)section_index,(int)(dbg->de_elf_sects[section_index]),(int)debug_names_size,(int)debug_names_size);
...
printf("dadebug final section size: %d\n",(int)stream_bytes_count);
...
printf("dadebug init bytes just after version added, pubnames\n");
dump(stream_bytes,35);
    }
    ...
    cur_stream_bytes_ptr += uword_size;
printf("dadebug init bytes just after cu offset 0 added, pubnames\n");
dump(stream_bytes,35);
...
printf("dadebug init bytes, pubnames\n");
dump(stream_bytes,35);
