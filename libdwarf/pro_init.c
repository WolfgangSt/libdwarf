...
Copyright (c) 1994-9 Silicon Graphics, Inc.
	...
	pro_init.c
	$Revision: 1.11 $    $Date: 1999/06/22 16:33:38 $    
	$Source: /isms/cmplrs.src/osprey1.0/libdwarf/RCS/pro_init.c,v $
...
common_init(Dwarf_P_Debug dbg,Dwarf_Unsigned flags)
{
    ...
    */
    ...
    dbg->de_ar_data_attribute_form = 
		(dbg->de_offset_size == 8)? DW_FORM_data8 :DW_FORM_data4;
    dbg->de_ar_ref_attr_form =
