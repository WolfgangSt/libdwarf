...
$Header: /plroot/cmplrs.src/v7.4.4m/.RCS/PL/dwarfdump/RCS/tag_attr.c,v 1.5 2004/10/28 22:26:58 davea Exp $ */
#include <dwarf.h>
#include <stdio.h>
...
static unsigned int tag_attr_combination_table[TABLE_SIZE][COLUMN_COUNT];
